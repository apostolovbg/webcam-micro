"""JavaScript translator for DevCovenant LanguageUnit generation."""
...
def _has_nearby_comment(line_number: int, lines: list[str]) -> bool:
    """Return True when a nearby JS comment marker is present."""
...
def translate(
    *, path: Path, source: str, declaration: TranslatorDeclaration, **_: Any
    ...
    """Translate JavaScript source into a policy-agnostic LanguageUnit."""
