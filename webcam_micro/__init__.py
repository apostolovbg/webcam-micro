...
BACKEND_STRATEGY = (
    ...
    "selected device-control owner per camera for device-reported exposure, "
    "focus, white balance, light, flicker, zoom, and vendor-specific "
    "settings, with Linux V4L2 adding extra device-specific discovery when "
    "available."
)
